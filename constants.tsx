...
export const PRE_CODED_GPTS: PreCodedGpt[] = [
  ...
  {
    id: 'doctor-ddx',
    title: 'General Differential Diagnosis',
    description: 'Input symptoms (e.g., "chest pain", "abdominal pain") to receive a structured list of potential diagnoses across all systems.',
    icon: <Icon name="diagnosis" />,
    roles: [UserRole.DOCTOR],
    customComponentId: 'DifferentialDiagnosis',
  },
  {
